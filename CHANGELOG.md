...
- `pack` command now prepends a generated `rbxex` version header to bundled output

### Fixed

- Bare `rbxex` now exits with code 0 after printing top-level help instead of exiting with a usage error code
- `init` command now automatically trusts generated toolchain sources before installing tools, including in `--yes` mode

## [0.4.1] - 2026-04-25

### Fixed

- `init` command now detects Windows command shims such as `npm.cmd` when resolving installed package managers
...
[Unreleased]: https://github.com/TerminalVibes/rbxex/compare/v0.5.0...HEAD
[0.5.0]: https://github.com/TerminalVibes/rbxex/compare/v0.4.1...v0.5.0
[0.4.1]: https://github.com/TerminalVibes/rbxex/compare/v0.4.0...v0.4.1
